...
// 0004_waku_mode.down.sql (0)
// 0004_waku_mode.up.sql (146B)
// doc.go (74B)
...
var __0004_waku_modeDownSql = []byte("\x1f\x8b\x08\x00\x00\x00\x00\x00\x00\xff\x01\x00\x00\xff\xff\x00\x00\x00\x00\x00\x00\x00\x00")

func _0004_waku_modeDownSqlBytes() ([]byte, error) {
	return bindataRead(
		__0004_waku_modeDownSql,
		"0004_waku_mode.down.sql",
	)
}

func _0004_waku_modeDownSql() (*asset, error) {
	bytes, err := _0004_waku_modeDownSqlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "0004_waku_mode.down.sql", size: 0, mode: os.FileMode(0644), modTime: time.Unix(1581952751, 0)}
	a := &asset{bytes: bytes, info: info, digest: [32]uint8{0xe3, 0xb0, 0xc4, 0x42, 0x98, 0xfc, 0x1c, 0x14, 0x9a, 0xfb, 0xf4, 0xc8, 0x99, 0x6f, 0xb9, 0x24, 0x27, 0xae, 0x41, 0xe4, 0x64, 0x9b, 0x93, 0x4c, 0xa4, 0x95, 0x99, 0x1b, 0x78, 0x52, 0xb8, 0x55}}
	return a, nil
}

var __0004_waku_modeUpSql = []byte("")

func _0004_waku_modeUpSqlBytes() ([]byte, error) {
	return bindataRead(
		__0004_waku_modeUpSql,
		"0004_waku_mode.up.sql",
	)
}

func _0004_waku_modeUpSql() (*asset, error) {
	bytes, err := _0004_waku_modeUpSqlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "0004_waku_mode.up.sql", size: 146, mode: os.FileMode(0644), modTime: time.Unix(1581952751, 0)}
...
var _bindata = map[string]func() (*asset, error){
	...
	"0004_waku_mode.down.sql": _0004_waku_modeDownSql,

	"0004_waku_mode.up.sql": _0004_waku_modeUpSql,
...
var _bintree = &bintree{nil, map[string]*bintree{
	...
	"0004_waku_mode.down.sql":        &bintree{_0004_waku_modeDownSql, map[string]*bintree{}},
	"0004_waku_mode.up.sql":          &bintree{_0004_waku_modeUpSql, map[string]*bintree{}},
